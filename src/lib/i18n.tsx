...
const dict = {
  ...
  etReminderToday: { sl: "Jutranji opomnik (danes)", en: "Same-day reminder" },
  etReminderTodaySub: { sl: "Na dan prevzema zjutraj.", en: "On the morning of the pickup." },
  emailTypeReminderToday: { sl: "Opomnik (na dan prevzema)", en: "Reminder (pickup day)" },
  viberTitle: { sl: "Viber sporočilo", en: "Viber message" },
  viberCopyBtn: { sl: "Kopiraj za Viber", en: "Copy for Viber" },
  viberOpenBtn: { sl: "Odpri v Viberju", en: "Open in Viber" },
  viberCopiedToast: { sl: "Viber sporočilo kopirano v odložišče!", en: "Viber message copied to clipboard!" },
  cronRunBtn: { sl: "Sproži opomnike zdaj (danes + jutri)", en: "Run reminders now (today + tomorrow)" },
  cronRunning: { sl: "Pošiljanje opomnikov…", en: "Dispatching reminders…" },
